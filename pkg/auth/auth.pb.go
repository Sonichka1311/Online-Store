...
func (x *Verification) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *Verification) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
var file_auth_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x22, 0x3c, 0x0a, 0x0c, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69,
	...
	0x3a, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x32, 0x0a, 0x0d, 0x56, 0x61, 0x6c, 0x69, 0x64,
	0x61, 0x74, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x0b, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e,
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x1a, 0x12, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x56, 0x65, 0x72,
	0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x00, 0x42, 0x08, 0x5a, 0x06, 0x2e,
...
var file_auth_proto_depIdxs = []int32{
	1, // 0: auth.Auth.ValidateToken:input_type -> auth.Token
	0, // 1: auth.Auth.ValidateToken:output_type -> auth.Verification
...
type AuthClient interface {
	ValidateToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*Verification, error)
}
...
func (c *authClient) ValidateToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*Verification, error) {
...
type AuthServer interface {
	ValidateToken(context.Context, *Token) (*Verification, error)
}
...
func (*UnimplementedAuthServer) ValidateToken(context.Context, *Token) (*Verification, error) {
